...
describe('helpers', withMocks({fs}, function (mocks) {
  ...
  describe('parseAaptStrings', function () {
    it('should parse strings received from aapt output', function () {
      const aaptOutput = `
      Package Groups (1)
      Package Group 0 id=0x7f packageCount=1 name=com.ait.armorapis
      Package 0 id=0x7f name=com.ait.armorapis
        type 0 configCount=1 entryCount=6
          config (default):
            resource 0x7f0c0215 com.ait.armorapis:string/linear_layout_8_vertical: t=0x03 d=0x0000044c (s=0x0008 r=0x00)
              (string16) "Vertical"
            resource 0x7f0c0216 com.ait.armorapis:string/linear_layout_8_horizontal: t=0x03 d=0x0000044d (s=0x0008 r=0x00)
              (string16) "Horizontal"
          config fr:
            resource 0x7f0c0215 com.ait.armorapis:string/linear_layout_8_vertical: t=0x03 d=0x0000044c (s=0x0008 r=0x00)
              (string16) "Vertical"
    ...
    it('should parse plurals received from aapt output', function () {
      const aaptOutput = `
        Package Groups (1)
        Package Group 0 id=0x7f packageCount=1 name=com.ait.armor.test
          Package 0 id=0x7f name=com.ait.armor.test
            type 0 configCount=1 entryCount=685
              spec resource 0x7f010000 com.ait.armor.test:attr/audioMessageDuration: flags=0x00000000
              spec resource 0x7f010001 com.ait.armor.test:attr/callingChatheadFooter: flags=0x00000000
              spec resource 0x7f010002 com.ait.armor.test:attr/callingChatheadInitials: flags=0x00000000
              spec resource 0x7f010003 com.ait.armor.test:attr/callingControlButtonLabel: flags=0x00000000
              spec resource 0x7f010004 com.ait.armor.test:attr/circleRadius: flags=0x00000000
              config de-rDE:
                resource 0x7f010000 com.ait.armor.test:attr/audioMessageDuration: <bag>
                  Parent=0x00000000(Resolved=0x7f000000), Count=1
                  #0 (Key=0x01000000): (color) #00000001
                resource 0x7f010001 com.ait.armor.test:attr/callingChatheadFooter: <bag>
                  Parent=0x00000000(Resolved=0x7f000000), Count=1
                  #0 (Key=0x01000000): (color) #00000001
              config de-rDE:
                resource 0x7f080000 com.ait.armor.test:string/abc_action_bar_home_description: t=0x03 d=0x00000c27 (s=0x0008 r=0x00)
                  (string8) "Navigate \\"home\\""
                resource 0x7f080001 com.ait.armor.test:string/abc_action_bar_home_description_format: t=0x03 d=0x00000ad1 (s=0x0008 r=0x00)
                  (string8) "%1$s, %2$s"
                resource 0x7f080002 com.ait.armor.test:string/abc_action_bar_home_subtitle_description_format: t=0x03 d=0x00000ad0 (s=0x0008 r=0x00)
                  (string8) "%1$s, %2$s, %3$s"
            type 1 configCount=1 entryCount=685
              config de-rDE:
                resource 0x7f0a0000 com.ait.armor.test:plurals/calling__conversation_full__message: <bag>
                ...
                resource 0x7f0a0001 com.ait.armor.test:plurals/calling__voice_channel_full__message: <bag>
            ...
            type 16 configCount=1 entryCount=8
              spec resource 0x7f110000 com.ait.armor.test:menu/conversation_header_menu_audio: flags=0x00000000
              spec resource 0x7f110001 com.ait.armor.test:menu/conversation_header_menu_collection: flags=0x00000000
              spec resource 0x7f110002 com.ait.armor.test:menu/conversation_header_menu_collection_searching: flags=0x00000000
              spec resource 0x7f110003 com.ait.armor.test:menu/conversation_header_menu_video: flags=0x00000000
              spec resource 0x7f110004 com.ait.armor.test:menu/conversation_multiuse: flags=0x00000000
              spec resource 0x7f110005 com.ait.armor.test:menu/toolbar_close_white: flags=0x00000000
              spec resource 0x7f110006 com.ait.armor.test:menu/toolbar_collection: flags=0x00000000
              spec resource 0x7f110007 com.ait.armor.test:menu/toolbar_sketch: flags=0x00000000
              config (default):
                resource 0x7f110000 com.ait.armor.test:menu/conversation_header_menu_audio: t=0x03 d=0x000000b6 (s=0x0008 r=0x00)
                  (string8) "res/menu/conversation_header_menu_audio.xml"
                resource 0x7f110001 com.ait.armor.test:menu/conversation_header_menu_collection: t=0x03 d=0x000000b7 (s=0x0008 r=0x00)
                  (string8) "res/menu/conversation_header_menu_collection.xml"
                resource 0x7f110002 com.ait.armor.test:menu/conversation_header_menu_collection_searching: t=0x03 d=0x000000b8 (s=0x0008 r=0x00)
                  (string8) "res/menu/conversation_header_menu_collection_searching.xml"
                resource 0x7f110003 com.ait.armor.test:menu/conversation_header_menu_video: t=0x03 d=0x000000b9 (s=0x0008 r=0x00)
                  (string8) "res/menu/conversation_header_menu_video.xml"
                resource 0x7f110004 com.ait.armor.test:menu/conversation_multiuse: t=0x03 d=0x000000ba (s=0x0008 r=0x00)
                  (string8) "res/menu/conversation_multiuse.xml"
                resource 0x7f110005 com.ait.armor.test:menu/toolbar_close_white: t=0x03 d=0x000000bb (s=0x0008 r=0x00)
                  (string8) "res/menu/toolbar_close_white.xml"
                resource 0x7f110006 com.ait.armor.test:menu/toolbar_collection: t=0x03 d=0x000000bc (s=0x0008 r=0x00)
                  (string8) "res/menu/toolbar_collection.xml"
                resource 0x7f110007 com.ait.armor.test:menu/toolbar_sketch: t=0x03 d=0x0000007f (s=0x0008 r=0x00)
  ...
  describe('parseAapt2Strings', function () {
    it('should parse strings received from aapt2 output', function () {
      const aapt2Output = `
      Binary APK
      Package name=com.ait.armorapis id=7f
  ...
  describe('parseJsonData', function () {
    it('should parse JSON received from broadcast output', function () {
      ...
      Broadcasting: Intent { act=com.ait.armorsettings.sms.read flg=0x400000 (has extras) }
