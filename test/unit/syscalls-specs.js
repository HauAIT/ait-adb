...
describe('System calls', withMocks({ait_process}, function (mocks) {
  afterEach(function () {
    mocks.verify();
  });
  ...
  describe('createSubProcess', function () {
    it('should return an instance of SubProcess', function () {
      adb.createSubProcess([]).should.be.an.instanceof(ait_process.SubProcess);
    });
  });
}));

describe('System calls', withMocks({adb, B, ait_process}, function (mocks) {
  afterEach(function () {
    mocks.verify();
  });
